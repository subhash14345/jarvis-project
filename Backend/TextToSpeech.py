...
def TextToSpeech(Text, func=lambda r=None: True):
    ...
    # If the text is very long (more than 4 sentences and 250 characters), add a response messsage
...
if __name__ == "__main__":
    while True:
        # Prompt the user for input and pass it to the TextToSpeech function
